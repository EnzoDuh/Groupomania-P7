...
//Regex de contrôle des injections sql
...
exports.updateUser = (req, res, next) => {
    //Récupération de la requête venant du front et de l'utilisateur ayant émit cette requête
    ...
    //Si au moins une des entrée n'est pas valide
    } else {
...
exports.updateUserPassword = (req, res, next) => {
    //Récupération de la requête venant du front et de l'id de l'utilisateur ayant émit cette requête
    const user = userId(req.headers.authorization);
